...
class Entity extends Admin_Controller {
    ...
    public function index() {
        $this->load->view('back-office-panel/entity');
    }

    public function add($id) {
        if (isset($id)) {
            $data["datas"] = $this->master->get_by_column("unique_id", $id);
            $this->load->view('back-office-panel/add_entity', $data);
        } else {
            $this->load->view('back-office-panel/add_entity');
        }
    }
    ...
    public function lists() {
        ...
        foreach ($list as $master) {
            ...
            $url = base_url() . "entity/" . replaceAll($master->main_category) . "/" . $master->unique_id;
...
//add html for action
            $row[] = '<a class="btn-floating waves-effect waves-light purple lightrn-1" href="' . base_url('back-office/entity-add/') . $master->unique_id . '" '
                    . 'title="Edit">
    ...
    public function save() {
        ...
        if ($id != "") {
            if (empty($_FILES['image']['name'])) {
                ...
                redirect('back-office-panel/entity');
            } else {
